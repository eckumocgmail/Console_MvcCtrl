...
using DescriptionAttribute = DetailsAnnotationsNS.DescriptionAttribute;

[EntityLabel("Тестирование ввода")]
[ClassDescription("Класс для тестирования атрибутов устанавливающих тип ввода")]
public class TestAttributeInputClass: MyValidatableObject
{
    ...
    [Icon("email")]
    [Description("Необходимо для авторизации")]
