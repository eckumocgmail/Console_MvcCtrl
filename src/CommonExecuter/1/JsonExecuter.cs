...
{
    public class JsonExecuter: BaseContainer
    {
       
        private readonly ISet<string> PrimitiveTypeNames = new HashSet<string>() {
            "String", "Boolean", "Double", "Int16", "Int32", "Int64", "UInt16", "UInt32", "UInt64" };

        private readonly ISet<string> ObjectMethods = new HashSet<string>() {
        ...
        private object GetSkeleton(object subject, List<string> path)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    Info(JObject.FromObject(subject));
        ...
        private void Info(object jObject)
        {
